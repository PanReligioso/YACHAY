...
return [ // retorna un array de configuraciones de servicios externos
    ...
    'google' => [ // configuracion del servicio Google Socialite
        'client_id' => env('GOOGLE_CLIENT_ID'), // id del cliente de Google OAuth
        'client_secret' => env('GOOGLE_CLIENT_SECRET'), // secreto del cliente de Google OAuth
        'redirect' => env('GOOGLE_REDIRECT_URI'), // URI de redireccion despues de la autenticacion
    ],
];
