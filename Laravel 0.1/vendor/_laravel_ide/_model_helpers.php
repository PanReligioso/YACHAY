...
namespace App\Models {
     ...
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Libro> $libros
     * @property-read int|null $libros_count
     * @method static \Illuminate\Database\Eloquent\Builder<CategoriaLibro>|CategoriaLibro whereIdCategoria($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CategoriaLibro>|CategoriaLibro whereNombreCategoria($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CategoriaLibro>|CategoriaLibro whereDescripcion($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CategoriaLibro>|CategoriaLibro whereIcono($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CategoriaLibro>|CategoriaLibro whereFechaCreacion($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CategoriaLibro>|CategoriaLibro newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<CategoriaLibro>|CategoriaLibro newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<CategoriaLibro>|CategoriaLibro query()
     ...
     */
    class CategoriaLibro extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property mixed $id_usuario_subida
     ...
     * @property mixed $id
     * @property-read \App\Models\CategoriaLibro $categoria
     * @property-read \App\Models\Usuario $usuario
     * @property-read \App\Models\Usuario $validador
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Libro>|Libro whereAutor($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Libro>|Libro whereDescripcion($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Libro>|Libro whereArchivoUrl($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Libro>|Libro whereVistas($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Libro>|Libro whereEstado($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Libro>|Libro whereIdUsuarioSubida($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Libro>|Libro whereIdCategoria($value)
     ...
     * @property string|null $codigo_universitario
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Usuario>|Usuario whereApellido($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Usuario>|Usuario whereCodigoUniversitario($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Usuario>|Usuario whereGoogleId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Usuario>|Usuario whereAvatar($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Usuario>|Usuario whereRolId($value)
