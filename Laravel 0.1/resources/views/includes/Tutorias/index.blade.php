...
@section('title', 'YACHAY - Grupos de Tutoría')
    ...
    <div class="container">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: var(--spacing-xl);">
            ...
            <?php if (session('logged_in')): ?>
                <a href="{{ url('/tutorias/crear') }}" class="btn btn-primary">
                ...
                <?php foreach ($grupos_filtrados as $grupo): ?>
                    ...
                    <div class="card" style="padding: var(--spacing-xl); position: relative;">
                        ...
                        <div style="display: flex; gap: var(--spacing-md); align-items: center;">
                            ...
                            <a href="{{ url('/tutorias') }}/<?= $grupo['id_grupo'] ?>" class="btn btn-secondary"
...
<section class="section" style="background: linear-gradient(135deg, var(--primary-600), var(--secondary-600));
    ...
    <div class="container">
        ...
        <a href="{{ url('/tutorias/crear') }}" class="btn"
