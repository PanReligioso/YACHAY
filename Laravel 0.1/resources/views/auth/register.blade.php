    ...
    <div class="card" style="max-width:550px; width:100%; padding:var(--spacing-2xl); box-shadow:var(--shadow-lg);">
        ...
        <form method="POST" action="{{ route('register') }}" novalidate>
            ...
            <div style="margin-bottom:var(--spacing-md);">
                ...
                <input id="nombre" type="text" name="nombre" value="{{ old('nombre') }}" required aria-required="true" autocomplete="name"
                ...
                @error('nombre')<div style="color:#ef4444; margin-top:6px;">{{ $message }}</div>@enderror
            </div>
            ...
            <div style="margin-bottom:var(--spacing-md);">
                ...
                <input id="apellido" type="text" name="apellido" value="{{ old('apellido') }}" required
                       style="width:100%; padding:var(--spacing-md); border:2px solid var(--primary-200); border-radius:var(--radius-md); font-size:var(--text-base);">
                @error('apellido')<div style="color:#ef4444; margin-top:6px;">{{ $message }}</div>@enderror
            </div>
            ...
            <div style="margin-bottom:var(--spacing-md);">
                ...
                <input id="email" type="email" name="email" value="{{ old('email') }}" required autocomplete="email"
                       style="width:100%; padding:var(--spacing-md); border:2px solid var(--primary-200); border-radius:var(--radius-md); font-size:var(--text-base);">
                @error('email')<div style="color:#ef4444; margin-top:6px;">{{ $message }}</div>@enderror
            </div>
            ...
            <div style="margin-bottom:var(--spacing-md);">
                ...
                <input id="codigo_universitario" type="text" name="codigo_universitario" value="{{ old('codigo_universitario') }}"
                       style="width:100%; padding:var(--spacing-md); border:2px solid var(--primary-200); border-radius:var(--radius-md); font-size:var(--text-base);">
                @error('codigo_universitario')<div style="color:#ef4444; margin-top:6px;">{{ $message }}</div>@enderror
            </div>
            ...
            <div style="margin-bottom:var(--spacing-md);">
                ...
                <input id="password" type="password" name="password" required minlength="6" autocomplete="new-password"
                       style="width:100%; padding:var(--spacing-md); border:2px solid var(--primary-200); border-radius:var(--radius-md); font-size:var(--text-base);">
                @error('password')<div style="color:#ef4444; margin-top:6px;">{{ $message }}</div>@enderror
            </div>
        ...
        <a href="{{ route('google.login') }}" class="btn" style="width:100%; display:flex; align-items:center; justify-content:center; gap:var(--spacing-sm); background:white; color:#333; border:2px solid var(--primary-200); margin-bottom:var(--spacing-md); padding:var(--spacing-md);">
        ...
        <div style="text-align:center; margin-top:var(--spacing-lg);">
            <p style="color:var(--text-secondary); margin:0;">
                ¿Ya tienes cuenta? <a href="{{ route('login') }}" style="color:var(--primary-600); font-weight:600;">Inicia sesión aquí</a>
            </p>
        </div>
    </div>
</div>
