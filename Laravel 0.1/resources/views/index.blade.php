...
<section class="section" style="background: linear-gradient(135deg, var(--primary-600), var(--secondary-600));
                                  color: var(--text-white); text-align: center; @if(!auth()->check()) margin: var(--spacing-3xl) 0; padding: var(--spacing-3xl) 0; @endif">
    <div class="container">
        ...
        <div style="display: flex; gap: @if(!auth()->check()) var(--spacing-lg) @else var(--spacing-md) @endif; justify-content: center; flex-wrap: wrap;">
            @if(auth()->check())
                <a href="{{ url('/libros/subir') }}" class="btn" style="background: var(--text-white);
            ...
            @else
                <a href="{{ url('/registro') }}" class="btn" style="background: var(--text-white);
                   color: var(--primary-600); padding: var(--spacing-lg) var(--spacing-2xl);
                   font-size: var(--text-lg);">
            ...
            @endif
            <a href="{{ url('/libros') }}" class="btn btn-outline" style="padding: var(--spacing-lg) var(--spacing-2xl);
               font-size: var(--text-lg);">
