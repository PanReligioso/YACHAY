<?php $__env->startSection('title', 'Iniciar Sesión - YACHAY'); ?>
...
<div style="min-height: 100vh; display: flex; align-items: center; justify-content: center;
    ...
    <div class="card" style="max-width: 450px; width: 100%; padding: var(--spacing-2xl);">
        ...
        <a href="<?php echo e(route('google.login')); ?>" class="btn"
        ...
        <div style="text-align: center; margin-top: var(--spacing-lg);">
            <p style="color: var(--text-secondary);">
                ¿No tienes cuenta?
                <a href="<?php echo e(route('register')); ?>" style="color: var(--primary-600); font-weight: 600;">
                    Regístrate aquí
                </a>
            </p>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\resources\views/auth/login.blade.php ENDPATH**/ ?>