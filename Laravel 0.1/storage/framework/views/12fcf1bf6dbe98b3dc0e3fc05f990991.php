...
<?php $__env->startSection('title', 'Subir Libro - YACHAY'); ?>
    ...
    <div class="container">
        <div style="max-width: 900px; margin: 0 auto;">
            ...
            <div class="card" style="padding: var(--spacing-2xl);">
                <form method="POST" action="<?php echo e(url('/libros/subir')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div style="display: flex; gap: var(--spacing-md); justify-content: flex-end;">
                        <a href="<?php echo e(url('/libros')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\resources\views/includes/Libros/subir.blade.php ENDPATH**/ ?>