<?php $__env->startSection('title', 'Apuntes - YACHAY'); ?>
            ...
            <form method="GET" style="margin-top: var(--spacing-2xl);">
                <div style="display: flex; gap: var(--spacing-md); max-width: 600px; margin: 0 auto; flex-wrap: wrap;">
                    <input type="text" name="buscar" placeholder="Buscar por título o descripción..."
                           value="<?php echo e(htmlspecialchars($buscar)); ?>"
    ...
    <div class="container">
        ...
        <div style="margin-bottom: var(--spacing-2xl);">
            ...
            <div style="display: flex; gap: var(--spacing-sm); flex-wrap: wrap;">
                <a href="?" class="btn <?php echo e(empty($cicloFiltro) ? 'btn-primary' : 'btn-secondary'); ?>"
                   style="padding: var(--spacing-sm) var(--spacing-lg);">Todos</a>
                <?php for($i = 1; $i <= 10; $i++): ?>
                    <a href="?ciclo=<?php echo e($i); ?><?php echo e($tipoFiltro ? '&tipo='.$tipoFiltro : ''); ?><?php echo e($buscar ? '&buscar='.$buscar : ''); ?>"
                       class="btn <?php echo e($cicloFiltro == $i ? 'btn-primary' : 'btn-secondary'); ?>"
                       style="padding: var(--spacing-sm) var(--spacing-lg);">Ciclo <?php echo e($i); ?></a>
                <?php endfor; ?>
            </div>
        </div>
        ...
        <div style="margin-bottom: var(--spacing-2xl);">
            ...
            <div style="display: flex; gap: var(--spacing-sm); flex-wrap: wrap;">
                <a href="?<?php echo e($cicloFiltro ? 'ciclo='.$cicloFiltro : ''); ?><?php echo e($buscar ? '&buscar='.$buscar : ''); ?>"
                   class="btn <?php echo e(empty($tipoFiltro) ? 'btn-primary' : 'btn-secondary'); ?>"
                   style="padding: var(--spacing-sm) var(--spacing-lg);">Todos</a>
                <?php $__currentLoopData = $tiposIconos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo => $config): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="?tipo=<?php echo e($tipo); ?><?php echo e($cicloFiltro ? '&ciclo='.$cicloFiltro : ''); ?><?php echo e($buscar ? '&buscar='.$buscar : ''); ?>"
                       class="btn <?php echo e($tipoFiltro == $tipo ? 'btn-primary' : 'btn-secondary'); ?>"
        ...
        <div style="margin-bottom: var(--spacing-lg);">
            <p style="color: var(--text-secondary); font-size: var(--text-lg);">
                <strong><?php echo e(count($apuntesFiltrados)); ?></strong> apuntes encontrados
            </p>
        </div>
        ...
        <?php if(count($apuntesFiltrados) > 0): ?>
            <div class="grid grid-3">
                <?php $__currentLoopData = $apuntesFiltrados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $apunte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <div class="card" style="padding: var(--spacing-xl); display: flex; flex-direction: column;">
                        ...
                        <div style="display: inline-flex; align-items: center; gap: var(--spacing-sm);
                                    ...
                                    background: <?php echo e($tipoConfig['color']); ?>20;
                                    border-radius: var(--radius-full); width: fit-content;
                                    margin-bottom: var(--spacing-md);">
                            <i class="fas <?php echo e($tipoConfig['icon']); ?>" style="color: <?php echo e($tipoConfig['color']); ?>;"></i>
                            <span style="color: <?php echo e($tipoConfig['color']); ?>; font-weight: 600; font-size: var(--text-sm);">
                                <?php echo e(ucfirst($apunte['tipo_material'])); ?>
                        ...
                        <h3 style="font-size: var(--text-xl); margin-bottom: var(--spacing-sm);
                            ...
                            <?php echo e(htmlspecialchars($apunte['titulo'])); ?>
                        ...
                        <?php if($curso): ?>
                            <p style="color: var(--text-secondary); font-size: var(--text-sm); margin-bottom: var(--spacing-md);">
                                ...
                                <?php echo e(htmlspecialchars($curso['nombre_curso'])); ?> - Ciclo <?php echo e($curso['ciclo']); ?>
                        ...
                        <p style="color: var(--text-secondary); font-size: var(--text-sm);
                            ...
                            <?php echo e(htmlspecialchars($apunte['descripcion'])); ?>
                        ...
                        <div style="display: flex; gap: var(--spacing-lg); margin-bottom: var(--spacing-lg);
                            ...
                            <span style="color: var(--text-tertiary); font-size: var(--text-sm);">
                                <i class="fas fa-eye"></i> <?php echo e($apunte['vistas'] ?? 0); ?>

                            </span>
                            <span style="color: var(--text-tertiary); font-size: var(--text-sm);">
                                <i class="fas fa-download"></i> <?php echo e($apunte['descargas'] ?? 0); ?>
                        ...
                        <div style="display: flex; gap: var(--spacing-sm);">
                            <a href="/apuntes/<?php echo e($apunte['id_apunte']); ?>" class="btn btn-primary"
                               style="flex: 1; font-size: var(--text-sm); padding: var(--spacing-sm) var(--spacing-md);">
                                <i class="fas fa-eye"></i> Ver Detalle
                            </a>
                            <a href="<?php echo e(htmlspecialchars($apunte['url_drive'])); ?>" target="_blank"
...
<!-- CTA Subir Apuntes -->
<?php if(session('logged_in', false) || auth()->check()): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\resources\views/includes/Apuntes/index.blade.php ENDPATH**/ ?>