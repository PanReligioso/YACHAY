<section class="hero">
    <div class="container">
        <div class="hero-container">
            ...
            <div class="hero-content">
                ...
                <div class="hero-actions">
                    <?php if(auth()->check()): ?>
                        <a href="<?php echo e(url('/libros/subir')); ?>" class="btn btn-primary">
                            <i class="fas fa-upload"></i>
                            Compartir Libro
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(url('/registro')); ?>" class="btn btn-primary">
        ...
        <div class="hero-features" id="features">
            <a href="<?php echo e(url('/libros')); ?>" class="feature-card" style="text-decoration: none; color: inherit;">
            ...
            <a href="<?php echo e(url('/apuntes')); ?>" class="feature-card" style="text-decoration: none; color: inherit;">
                <div class="feature-icon">
            ...
            <a href="<?php echo e(url('/tutorias')); ?>" class="feature-card" style="text-decoration: none; color: inherit;">
                <div class="feature-icon">
            ...
            <a href="<?php echo e(url('/comedores')); ?>" class="feature-card" style="text-decoration: none; color: inherit;">
                <div class="feature-icon">
...
<?php /**PATH C:\xampp\htdocs\laravel\resources\views/partials/hero.blade.php ENDPATH**/ ?>